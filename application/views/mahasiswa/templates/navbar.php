...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/scss/vertical-layout-light/_sidebar.scss">
    <link rel="stylesheet" href="<?= base_url() ?>assets/vendors/ti-icons/css/themify-icons.css">
    <link rel="stylesheet" href="<?= base_url() ?>assets/vendors/css/vendor.bundle.base.css">
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <style>
        /* Aturan CSS untuk semua layar */
        .sidebar {
            ...
            overflow-y: auto;
            /* Agar bisa digulir jika konten terlalu panjang */
